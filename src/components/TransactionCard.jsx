...
import { formatToIDRCurrency,capitalizeFirstLetter, formatPosterURL,dateToDDMonthYYYY } from '../utils/stringProcess'
  ...
  return (
    <div className="flex flex-row justify-between items-center bg-white w-full rounded-md shadow-md">
      <div className="flex flex-row justify-center items-center gap-4">
        <img
          src={props.type=="buy"?formatPosterURL(data.poster_path):iconMoney}
          alt="poster"
          className={props.type=="buy"?"h-24 w-[10vw] object-cover rounded":"ms-10 w-[40px] "}
        />
        <div className="flex flex-col justify-center items-start py-4 px-2  text-sm">
          {props.type=="buy"?
            ...
            <div>
            <p className='font-bold text-lg'>{capitalizeFirstLetter(props.type)}</p>
